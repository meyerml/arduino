...
byte timeDisplayMode = 0;                       // @EB-setup 0: UU : MM    hour and min normal font with blinking colon
                                                //           1: UU MM ss   hour and min normal font, sec 3p font, no colon
                                                //           2: uu mm ss   hour, min and sec 4p font, no colon
                                                //           3: uu mm : ss hour, min and sec 4p font, colon
...
unsigned int sleepDelay = 30;                  // @EB-custom delay time in seconds
...
bool suspendMode = false;
  ...
  float BME280_temperatureCalFactor =  0.0;       // @EB-setup
  float BME280_temperatureCalValue  =  0.0;       // @EB-setup 
  float BME280_humidityCalFactor    =  0.0;       // @EB-setup 
  float BME280_humidityCalValue     =  0.0;       // @EB-setup 
  float BME280_pressureCalFactor    =  0.0;       // @EB-setup 
...
const int UI_channel = 8;                       // @EB-todo ignored, the ESP resets it to the routers WiFi channel (?)
  ...
  const unsigned int ls_minSensor = 0;        // @EB-custom min input value of the light sensor (0 to 1024 for ESP8266, 0 to 4096 for ESP32)
  #ifdef ESP32
